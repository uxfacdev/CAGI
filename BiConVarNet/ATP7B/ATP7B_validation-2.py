...
def validate_variant(variant: str) -> bool:
    ...
    if reference_base not in residues_three:
        ...
        return False
    if variant[-1] != '=' and variant[-3:] not in residues_three and variant[-3:] != 'Ter':
    ...
    with open(file_path, 'r') as file:
        ...
        for line in file:
            ...
            if not (
                ...
                validate_nonzero(prediction, "prediction") and
                validate_nonzero(sd_prediction, "Standard deviation (SD)")
            ):
...
if __name__ == "__main__":
    ...
    validate_file("/mnt/c/Users/Kunny/Research/Project/BiConVarNet/ATP7B/UXFactory_model_1.tsv")
