...
import numpy as np
import pandas as pd
from extract_struct_features_more import extract_struct_S, load_ddg_map  
...
out_dir    = r"C:\Users\Kunny\Research\Dataset\Missense_Variant_dataset\struct_feature_cache_PTEN_TPMT_2"
